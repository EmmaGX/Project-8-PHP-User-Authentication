...
<body>
    ...
    <svg style="display: none;">
        <defs>
            ...
            <path d="M367.9,109.9c-47,53-87.7,113.6-122.9,183.1h70.8c9.9,0,18,8
         .1,18,18s-8.1,18-18,18h-88.3
	...
	<header class="header">
        ...
        <li class="nav-item tasks<?php if ($page == "tasks") { echo " on"; }
        ?>"><a class="nav-link" href="task_list.php">View Tasks</a></li>
<!--        Only show add tasks tab if the user is authenticated        -->
...
<!--        Only show login and register if the user is not logged in and
            ...
            <?php if (isAuthenticated()) : ?>
            <li class="nav-item tasks"><a class="nav-link" href="account.php">My Account</a></li>
